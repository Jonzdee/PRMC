...
export default function Page() {
  ...
  const keyFeatures = [
    {
      ...
      description: "Detailed profitability assessment for each product, service, or product line",
    },
    {
      icon: PieChart,
      title: "Market Segmentation",
      description: "Customer profitability analysis by segment, channel, and geography",
    },
    {
      icon: Target,
      title: "Cost Attribution",
      description: "Accurate allocation of direct and indirect costs to products and markets",
    },
    {
      icon: LineChart,
      title: "Trend Analysis",
      description: "Historical performance trends and forward-looking profitability projections",
    },
  ];

  const benefits = [
    "Identify your most and least profitable products/services",
    "Optimize pricing strategies based on true cost-to-serve",
    "Make data-driven decisions on product discontinuation or investment",
    "Focus sales efforts on highest-margin opportunities",
    "Reduce costs by eliminating unprofitable activities",
    "Improve resource allocation across product lines and markets",
    "Understand customer profitability to optimize acquisition costs",
    "Create competitive advantage through superior cost intelligence",
  ];
  ...
  const process = [
    {
      ...
      description: "Gather financial, operational, and sales data across all products and markets.",
    },
    {
      step: "02",
      title: "Cost Allocation",
      description: "Build accurate cost models allocating expenses to products and customers.",
    },
    {
      step: "03",
      title: "Profitability Modeling",
      description: "Calculate contribution margins, gross profit, and net profitability by dimension.",
    },
    {
      step: "04",
      title: "Comparative Analysis",
      description: "Benchmark performance across products, markets, and customer segments.",
    },
    {
      step: "05",
      title: "Insights & Recommendations",
      description: "Identify optimization opportunities and strategic recommendations.",
    },
    {
      step: "06",
      title: "Action Planning",
      description: "Develop roadmap to improve portfolio mix and market positioning.",
    },
  ];
  ...
  const deliverables = [
    ...
    "Portfolio Rationalization Plan",
    "Monthly Profitability Tracking Tools",
  ];
  ...
  return (
    <>
      ...
      <div className="w-full" style={{ backgroundColor: colors.lightBg }}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                >
                  Product & Market{" "}
                  <span style={{ color: colors.gold }}>Profitability Analysis</span>
                </h1>
                ...
                >
                  Discover which products, services, and markets truly drive your bottom line.
                  Make strategic decisions based on precise profitability intelligence.
                </p>
        ...
        {/* Key Features - same structure as before */}
        <section className="py-20 md:py-32">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              >
                Comprehensive analysis across all dimensions of your business profitability
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p
                  ...
                  style={{ color: `${colors.navyBlue}99` }}
                >
                  Stop guessing which parts of your business make money. Get precise insights
              ...
              >
                <div className="space-y-6">
                  <DollarSign className="w-12 h-12" style={{ color: colors.gold }} />
                  <h3
                  ...
                  <p
                    ...
                    style={{ color: `${colors.white}cc` }}
                  >
                    Many businesses unknowingly subsidize unprofitable products with their
                    winners. Our analysis reveals where you are leaving money on the table and
                    how to capture it.
                  </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p
                ...
                style={{ color: `${colors.navyBlue}99` }}
              >
                A rigorous methodology to uncover profitability insights across your entire
                portfolio
              </p>
            </div>
        ...
        >
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2
              ...
              style={{ color: colors.white }}
            >
              Ready to Uncover Your True Profitability?
            </h2>
            <p
              className="text-lg md:text-xl mb-10"
              style={{ color: `${colors.white}cc` }}
            >
              Schedule a consultation to learn how profitability analysis can transform your
              business strategy.
            </p>
